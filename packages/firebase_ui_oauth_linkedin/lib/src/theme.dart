...
const _linkedInBlue = Color(0xff009EF7);
const _linkedInWhite = Color(0xffffffff);

const _backgroundColor = ThemedColor(_linkedInBlue, _linkedInBlue);
const _color = ThemedColor(_linkedInWhite, _linkedInWhite);
...
class LinkedInProviderButtonStyle extends ThemedOAuthProviderButtonStyle {
  const LinkedInProviderButtonStyle();
  ...
  @override
  String get assetsPackage => 'firebase_ui_oauth_linkedin';
}
